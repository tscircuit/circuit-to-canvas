...
import brepExampleCircuit from "./brep-example.json"

const circuitElements = brepExampleCircuit as AnyCircuitElement[]

test("BREP example - comprehensive comparison (circuit-to-canvas vs circuit-to-svg)", async () => {
